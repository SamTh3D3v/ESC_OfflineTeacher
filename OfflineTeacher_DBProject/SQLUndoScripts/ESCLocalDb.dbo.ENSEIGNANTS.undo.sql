...
IF @@TRANCOUNT > 0
ALTER TABLE [dbo].[ENSEIGNANTS] DROP CONSTRAINT [DF_ENSEIGNANTS_LastEditDate]
GO
IF @@ERROR <> 0 
...
IF @@TRANCOUNT > 0
ALTER TABLE [dbo].[ENSEIGNANTS] DROP COLUMN [LastEditDate]
GO
IF @@ERROR <> 0 
     ROLLBACK TRANSACTION;
...
IF @@TRANCOUNT > 0
ALTER TABLE [dbo].[ENSEIGNANTS] DROP CONSTRAINT [DF_ENSEIGNANTS_CreationDate]
GO
IF @@ERROR <> 0 
     ROLLBACK TRANSACTION;
...
IF @@TRANCOUNT > 0
ALTER TABLE [dbo].[ENSEIGNANTS] DROP COLUMN [CreationDate]
GO
IF @@ERROR <> 0 
     ROLLBACK TRANSACTION;
