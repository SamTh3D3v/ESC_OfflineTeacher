...
IF @@TRANCOUNT > 0
ALTER TABLE [dbo].[NOTES_EXAMEN] DROP CONSTRAINT [DF_NOTES_EXAMEN_LastEditDate]
GO
IF @@ERROR <> 0 
...
IF @@TRANCOUNT > 0
ALTER TABLE [dbo].[NOTES_EXAMEN] DROP COLUMN [LastEditDate]
GO
IF @@ERROR <> 0 
     ROLLBACK TRANSACTION;
...
IF @@TRANCOUNT > 0
ALTER TABLE [dbo].[NOTES_EXAMEN] DROP CONSTRAINT [DF_NOTES_EXAMEN_CreationDate]
GO
IF @@ERROR <> 0 
     ROLLBACK TRANSACTION;
...
IF @@TRANCOUNT > 0
ALTER TABLE [dbo].[NOTES_EXAMEN] DROP COLUMN [CreationDate]
GO
IF @@ERROR <> 0 
     ROLLBACK TRANSACTION;
...
IF @@TRANCOUNT > 0
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[NOTES_EXAMEN_Tombstone]') and TYPE = N'U') 
   DROP TABLE [dbo].[NOTES_EXAMEN_Tombstone];
