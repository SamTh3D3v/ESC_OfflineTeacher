...
namespace SyncLibrary
{
    ...
    {
        //private string conString = ConfigurationManager.ConnectionStrings["DBConnection"].ConnectionString;
        private string conString = "data source=ELHAMER-PC\\SQLEXPRESS;initial catalog=SGSDB;integrated security=True;Persist Security Info=false;";
        /// <summary>
